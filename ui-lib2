        ...
        function group:addToggle(args)
            ...
            function toggleObj:addColorpicker(cargs)
                ...
                cbutton.MouseEnter:Connect(function()
                    cmid.BorderColor3 = library.libColor
                end)
